...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,1814415004,1335307516}
...
if hash or Bot(msg) or DevBRINGO(msg) or DevBotsIs(msg) then    
return true  
else  
return false  
end  
...
if hash or Bot(msg) or DevBRINGO(msg) or DevBot(msg) or DevBotsIs(msg) then     
return true 
else 
return false 
end 
...
if hash or Bot(msg) or DevBRINGO(msg) or DevBot(msg) or DevBotsIs(msg) or creatorA(msg) then     
return true 
else 
return false 
end 
...
if hash or Bot(msg) or DevBRINGO(msg) or DevBot(msg) or BasicConstructor(msg) or DevBotsIs(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or Bot(msg) or DevBRINGO(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or DevBotsIs(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or Bot(msg) or DevBRINGO(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or DevBotsIs(msg) or creatorA(msg) then             
return true    
else    
return false    
end 
...
if hash or Bot(msg) or  DevBRINGO(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) or DevBotsIs(msg) or creatorA(msg) then             
return true 
else 
return false 
end 
...
if DevBRINGOe(user_id) == true then
var = true
elseif DevBRINGO(user_id) == true then
var = true
...
if tonumber(user_id) == tonumber(1814415004) then  
var = true  
...
elseif tonumber(user_id) == tonumber(1335307516) then  
var = "مالك السورس"  
elseif DevBRINGOe(user_id) == true then
var = "المطور الاساسي"  
elseif tonumber(user_id) == tonumber(bot_id) then  
var = "البوت"
...
local UserName = (data.username_ or "UUE_C")
...
function BRINGO_Started_Bot(msg,data) -- بداية العمل
if msg then
...
local BRINGO_Msg = database:sismember(bot_id.."List:Filter:text"..msg.chat_id_,text) 
if BRINGO_Msg then    
...
if text == ("رفع مارفل") and tonumber(msg.reply_to_message_id_) ~= 0 and DevBotsIs(msg) then
function Function_BRINGO(extra, result, success)
database:sadd(bot_id.."DEV:Sudo:T", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","💕: تم ترقيته مارفل في البوت")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_BRINGO, nil)
return false 
end
if text and text:match("^رفع مارفل @(.*)$") and DevBotsIs(msg) then
local username = text:match("^رفع مارفل @(.*)$")
function Function_BRINGO(extra, result, success)
if result.id_ then
...
Reply_Status(msg,result.id_,"reply","💕: تم ترقيته مارفل في البوت")  
else
...
if text and text:match("^رفع مارفل (%d+)$") and DevBotsIs(msg) then
local userid = text:match("^رفع مارفل (%d+)$")
database:sadd(bot_id.."DEV:Sudo:T", userid)
Reply_Status(msg,userid,"reply","💕: تم ترقيته مارفل في البوت")  
return false 
end
if text == ("حذف مارفل") and tonumber(msg.reply_to_message_id_) ~= 0 and DevBotsIs(msg) then
function Function_BRINGO(extra, result, success)
database:srem(bot_id.."DEV:Sudo:T", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","💕: تم تنزيله من مارفل")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_BRINGO, nil)
return false 
end
if text and text:match("^حذف مارفل @(.*)$") and DevBotsIs(msg) then
local username = text:match("^حذف مارفل @(.*)$")
function Function_BRINGO(extra, result, success)
if result.id_ then
database:srem(bot_id.."DEV:Sudo:T", result.id_)
Reply_Status(msg,result.id_,"reply","💕: تم تنزيله من مارفل")  
else
send(msg.chat_id_, msg.id_,"💕: لا يوجد حساب بهاذا المعرف")
end
end
...
if text and text:match("^حذف مارفل (%d+)$") and DevBotsIs(msg) then
local userid = text:match("^حذف مارفل (%d+)$")
database:srem(bot_id.."DEV:Sudo:T", userid)
Reply_Status(msg,userid,"reply","💕: تم تنزيله من مارفل")  
return false 
end
if text == ("مارفل") and DevBRINGO(msg) then
local list = database:smembers(bot_id.."DEV:Sudo:T")
t = "\n💕: قائمة مطورين مارفل للبوت \n — — — — — — — — — \n"
for k,v in pairs(list) do
...
if text == ("مسح مارفل") and DevBotsIs(msg) then
database:del(bot_id.."DEV:Sudo:T")
send(msg.chat_id_, msg.id_, "\n💕:  تم مسح قائمة المطورين مارفل  ")
end
...
if text == ("قائمه كتم عام") and DevBRINGO(msg) then
...
if text == ("حظر عام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevBRINGO(msg) then
function Function_BRINGO(extra, result, success)
if result.sender_user_id_ == tonumber(Id_Sudo) then
send(msg.chat_id_, msg.id_, "💕: لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور البوت الاساسي \n")
return false 
end
if result.sender_user_id_ == tonumber(1814415004) then
send(msg.chat_id_, msg.id_, "💕: لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
if result.sender_user_id_ == tonumber(1335307516) then
send(msg.chat_id_, msg.id_, "💕: لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مالك السورس \n")
return false
end
...
if result.id_ == tonumber(1814415004) then
send(msg.chat_id_, msg.id_, "💕: لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
...
if userid == tonumber(1814415004) then
send(msg.chat_id_, msg.id_, "💕: لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
if userid == tonumber(1335307516) then
send(msg.chat_id_, msg.id_, "💕: لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مالك السورس \n")
return false
end
...
if text == ("كتم عام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevBRINGO(msg) then
function Function_BRINGO(extra, result, success)
if result.sender_user_id_ == tonumber(Id_Sudo) then
send(msg.chat_id_, msg.id_, "💕: لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور البوت الاساسي \n")
return false 
...
Kick_Group(result.chat_id_, result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","💕: تم كتمه عام من جروبات")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_BRINGO, nil)
return false
end
...
if text == ("الغاء العام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevBRINGO(msg) then
function Function_BRINGO(extra, result, success)
...
if text == ("اضف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevBRINGO(msg) then
function Function_BRINGO(extra, result, success)
...
if text and text:match("^اضف مطور @(.*)$") and DevBRINGO(msg) then
...
if text and text:match("^اضف مطور (%d+)$") and DevBRINGO(msg) then
local userid = text:match("^اضف مطور (%d+)$")
database:sadd(bot_id.."Sudo:User", userid)
Reply_Status(msg,userid,"reply","💕: تم ترقيته مطور في البوت")  
return false 
end
if text == ("حذف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevBRINGO(msg) then
function Function_BRINGO(extra, result, success)
...
if text and text:match("^حذف مطور @(.*)$") and DevBRINGO(msg) then
...
if text and text:match("^حذف مطور (%d+)$") and DevBRINGO(msg) then
...
local BRINGOrt = database:get(bot_id.."Comd:New:rt:bot:"..RTPA..msg.chat_id_)
if BRINGOrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"💕: العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "UUE_C")..")".."\n💕: تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA) 
database:sadd(bot_id.."Special:User"..msg.chat_id_,result.sender_user_id_)  
elseif BRINGOrt == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"💕: العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "UUE_C")..")".."\n💕: تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)
database:sadd(bot_id.."Mod:User"..msg.chat_id_,result.sender_user_id_)  
elseif BRINGOrt == "مدير" and Constructor(msg) then
send(msg.chat_id_, msg.id_,"💕: العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "UUE_C")..")".."\n💕: تم رفعه "..RTPA.." هنا\n")
database:set(bot_id.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)  
database:sadd(bot_id.."Manager"..msg.chat_id_,result.sender_user_id_)  
elseif BRINGOrt == "عضو" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"💕: العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "UUE_C")..")".."\n💕: تم رفعه "..RTPA.." هنا\n")
end
end,nil)   
end   
...
if result.id_ then
local BRINGOrt = database:get(bot_id.."Comd:New:rt:bot:"..text1[2]..msg.chat_id_)
if BRINGOrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"💕: العضو -› ["..result.title_.."](t.me/"..(text1[3] or "UUE_C")..")".."\n💕: تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."Special:User"..msg.chat_id_,result.id_)  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n💕> العضو > ['..data.first_name_..'](t.me/'..(data.username_ or 'UUE_C')..') ~'
...
usertext = '\n💕 العضو > ['..result.title_..'](t.me/'..(username or 'UUE_C')..')'
status  = '\n💕 تم تقيده لمدة  { '..TextEnd[2]..' '..TextEnd[3]..'}'
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n💕:  العضو -› ['..data.first_name_..'](t.me/'..(data.username_ or 'BRINGO')..') '
...
------------------------------------------------------------------------
if text == ("مسح ردود المطور") and DevBRINGO(msg) then 
...
if text == ("ردود المطور") and DevBRINGO(msg) then 
local list = database:smembers(bot_id.."List:Rd:Sudo")
text = "\n💕: قائمة ردود المطور \n — — — — — — — — —\n"
for k,v in pairs(list) do
...
if text == "اضف رد للكل" and DevBRINGO(msg) then 
send(msg.chat_id_, msg.id_,"💕:  ارسل الكلمه التري تريد اضافتها")
database:set(bot_id.."Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text == "حذف رد للكل" and DevBRINGO(msg) then 
...
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'UUE_C')..')'
...
if text == 'كشف' and tonumber(msg.reply_to_message_id_) > 0 and
                    not database:get(bot_id .. 'BRINGO:Lock:ID:Bot' .. msg.chat_id_) then
                    function Function_BRINGO(extra, result, success)
                        tdcli_function({
                            ID = "GetUser",
...
local UserName = (b.username_ or "UUE_C")
...
if text == (database:get(bot_id.."Name:Bot") or "مارفل") then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
Namebot = (database:get(bot_id.."Name:Bot") or "مارفل")
local namebot = {
...
if database:get(bot_id.."Status:Bc") and not DevBRINGO(msg) then 
...
os.execute('wget https://raw.githubusercontent.com/BRINGO-DeV/BRINGO/main/BRINGO.lua')
os.execute('wget https://raw.githubusercontent.com/BRINGO-DeV/BRINGO/main/start.lua')
dofile('BRINGO.lua')  
return false
end
if text == "راسلني" then
...
zh = https.request('https://BRINGO-api.ml/frills.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n💕️ : قائمه الزخرفه \n — — — — — — — — — \n"
i = 0
...
gk = https.request('https://BRINGO-api.ml/Horoscopes.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
...
ge = https.request('https://BRINGO-api.ml/Calculateage.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
send(msg.chat_id_, msg.id_, ag.ok.hso)
end
if text == 'السيرفر' and DevBRINGO(msg) then 
...
data,res = https.request('https://BRINGO-api.ml/infoInstagram.php?username='..URL.escape(Textni)..'')
if res == 200 then
...
data,res = https.request('https://BRINGO-api.ml/movie.php?serch='..URL.escape(Textm)..'')
if res == 200 then
...
if text == "غنيلي" then
data,res = https.request('https://BRINGO-api.ml/audios.php')
if res == 200 then
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '- ᎷᎪᎡᏙᎬᏞ ՏΌႮᎡᏟᎬ .',url="t.me/UUE_C"}},
}
local msg_id = msg.id_/2097152/0.5
...
st = https.request('https://BRINGO-api.ml/ImageInfo.php?token='..token..'&url='..sticker_id.."&type=sticker")
eker = JSON.decode(st)
...
Srrt = https.request('https://BRINGO-api.ml/ImageInfo.php?token='..token..'&url='..photo_id.."&type=photo")
...
if text and text:match("^تعين عدد الاعضاء (%d+)$") and DevBRINGO(msg) then
...
if text == 'جلب نسخه احتياطيه' and DevBRINGO(msg) then
local list = database:smembers(bot_id..'Chek:Groups')  
local memo = database:smembers(bot_id..'UsersBot')  
local t = '{"BOT_ID": '..bot_id..',"GP_BOT":{'  
for k,v in pairs(list) do   
...
if DevBRINGO(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/BRINGO-DeV/files_BRINGO/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n💕: اهلا بك في متجر ملفات مارفل\n💕: يوجد في المتجر ملف الردود \n — — — — — — — — — \n"
...
if text and text:match("^(تعطيل ملف) (.*)(.lua)$") and DevBRINGO(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/BRINGO-DeV/files_BRINGO/main/files_BRINGO/"..file)
if res == 200 then
...
if text and text:match("^(تفعيل ملف) (.*)(.lua)$") and DevBRINGO(msg) then
...
if text == "مسح جميع الملفات" and DevBRINGO(msg) then
os.execute("rm -fr Files/*")
send(msg.chat_id_,msg.id_,"💕: تم حذف جميع الملفات")
return false
end
if text == 'نقل الاحصائيات' and DevBRINGO(msg) then
...
if text == 'حذف كليشه المطور' and DevBRINGO(msg) then
database:del(bot_id..'Text_Dev')
send(msg.chat_id_, msg.id_,'💕:  تم حذف كليشه المطور')
end
if text == 'وضع كليشه المطور' and DevBRINGO(msg) then
...
if text == 'رفع النسخه الاحتياطيه' and DevBRINGO(msg) then   
if tonumber(msg.reply_to_message_id_) > 0 then
function by_reply(extra, result, success)   
...
local url,res = https.request('https://BRINGO-api.ml/ChatMember.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.info ~= true then
send(msg.chat_id_,msg.id_,'💕: شترك في قناة السورس اولآ @UUE_C .')   
return false 
end
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ՏΌႮᎡᏟᎬ ᎷᎪᎡᏙᎬᏞ\n\n[-  ʙᴏʏᴋᴀ ᴄʜᴀɴɴᴇʟ  .](http://t.me/UUE_C)\n\n[-  ɪɴғᴏ sᴏᴜʀᴄᴇ .](http://t.me/UUE_C)\n\n[-  ʙᴏʏᴋᴀ ᴅᴇᴠᴇʟᴏᴘᴇʀ  .](http://t.me/BringoXx)\n\n[-  ʙᴏᴛ ʙᴏʏᴋᴀ .](http://t.me/rriebot)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '💕: ᎷᎪᎡᏙᎬᏞ ՏΌႮᎡᏟᎬ .',url="t.me/UUE_C"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/UUE_C&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if not DevBRINGO(msg) and not database:sismember(bot_id..'BaN:In:User',msg.sender_user_id_) and not database:get(bot_id..'Texting:In:Bv') and not database:get(bot_id.."Filter"..msg.sender_user_id_) then
...
if text =='💕: مارفل .' and not DevBotsIs(msg) then
...
if text =='💕: مسح مارفل .' and not DevBotsIs(msg) then
send(msg.chat_id_, msg.id_,'💕: تسرسح .')
end
...
send(msg.chat_id_, msg.id_,'💕: [تحديثات البوت](t.me/UUE_C) .\n - [قناه السورس](t.me/UUE_C) .')
return false  
end
...
if text and text:match("^- تعين قناة الاشتراك 💕 .$") and DevBRINGO(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '💕: حسنآ ارسل لي معرف القناة')
return false  
end
...
if text == ("قائمه المكتومين العام 💕") and DevBRINGO(msg) then
local list = database:smembers(bot_id.."GMuted:User")
...
inline = {
{{text = '💕:  - ՏΌႮᎡᏟᎬ ᎷᎪᎡᏙᎬᏞ  .',url='http://t.me/UUE_C'}},
}
...
local Name_Bot = (database:get(bot_id.."Name:Bot") or "مارفل")
...
------------------------------------------------------------------------
if text then
local BRINGO_Msg = database:sismember(bot_id.."List:Filter:text"..result.chat_id_,text) 
if BRINGO_Msg then    
